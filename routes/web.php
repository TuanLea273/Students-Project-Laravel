...
Route::middleware('auth')->group(function(){
    ...
    Route::prefix('nguoi-choi')->group(function(){
        ...
        Route::get('them-moi','NguoiChoiController@create')->name('them-moi-nguoi-choi');
        Route::post('them-moi','NguoiChoiController@store')->name('xu-ly-them-moi-nguoi-choi');        Route::get('chinh-sua/{id}','NguoiChoiController@edit')->name('chinh-sua-nguoi-choi') ;
